			...
			model.getEntries(fileInput.files[0], function(entries) {
				...
				entries.forEach(function(entry) {
					...
					if(extension.length > 1){
						...
						$("#loadingConfirmation").append("<div style='height:25px;margin-top:10px;'><i  id='fileNumber"+String(xcounter)+"' class='fa fa-clock-o' style='color:orange;'></i></div>");
						li.appendChild(a);
